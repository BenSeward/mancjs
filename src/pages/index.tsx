  ...
  return (
    <>
      ...
      <main className={lato.className}>
        <Container>
          <Header />
          <Section header={'Welcome to Manc.JS'} paragraph={'We run Javascript & tech events every-other month around central Manchester.'} buttonText={'Join our next event!'}/>
          <h2>Next event</h2>
          ...
          <Section header={'Get in touch'} paragraph={'We love hearing from our community. If you want to come to an event but have a question reach out to one of our organisers on Meetup.'} buttonText={'Get in touch'}/>
        </Container>
      </main>
    </>
  );
